...
![.NET 8](https://img.shields.io/badge/.NET-8.0-blue) ![C#](https://img.shields.io/badge/C%23-10.0-blue) ![EF Core](https://img.shields.io/badge/EF_Core-8.0-512BD4) ![SQLite](https://img.shields.io/badge/SQLite-3.0-003B57) ![Azure App Service](https://img.shields.io/badge/Azure-App%20Service-blue) ![REST Client](https://img.shields.io/badge/REST_Client-VSCode-blue)
...
- `Portfolio_API.DataAccess/Contexts/` — `EmployeeDbContext`, `ResumeDbContext`
